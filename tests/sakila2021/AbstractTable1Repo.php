...
/**
 * Class AbstractTable1Repo. Copyright (c) Jorge Castro C. (https://github.com/EFTEC/PdoOne)<br>
 ...
 */
abstract class AbstractTable1Repo extends Sakila_lite
{
    public static $ENTITY = 'Table1Repo';
    ...
    */
    ...
    {
        return static::newQuery()->where($sql, $param,false,Table1Repo::$TABLE);
    }
    ...
    */
    public static function recursive($recursive=[]): PdoOneQuery
    {
        if(is_string($recursive)) {
            $recursive=Table1Repo::getRelations($recursive);
        }
