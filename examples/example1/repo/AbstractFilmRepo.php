...
abstract class AbstractFilmRepo extends Sakila
{
    ...
    *
    * @param string|array $recursive=['/_language_id','/_original_language_id','/_film_actor','/_inventory'];
    *
    * @return PdoOneQuery
    */
