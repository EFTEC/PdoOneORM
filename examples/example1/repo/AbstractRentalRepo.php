...
{
    public static $ENTITY = 'RentalRepo';
    public static $TABLE = 'rental';
    /** @var string A string with the name of the class. It is used to identify itself. */
    public static $IDENTITY = 'rental_id';
    ...
    *
    * @param string|array $recursive=['/_customer_id','/_inventory_id','/_staff_id'];
    *
    * @return PdoOneQuery
    */
