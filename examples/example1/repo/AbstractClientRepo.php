...
/**
 * Class AbstractClientRepo. Copyright (c) Jorge Castro C. (https://github.com/EFTEC/PdoOne)<br>
 ...
 */
abstract class AbstractClientRepo extends Sakila
{
    public static $ENTITY = 'ClientRepo';
    ...
    */
    public static function convertOutputVal(?array &$row): void
    {
		...
		!isset($row['nombre']) and $row['nombre']=null; // varchar
		!isset($row['apellido']) and $row['apellido']=null; // varchar
		!isset($row['correo']) and $row['correo']=null; // varchar
    ...
    */
    ...
    {
        return static::newQuery()->where($sql, $param,false,ClientRepo::$TABLE);
    }
    ...
    */
    public static function recursive($recursive=[]): PdoOneQuery
    {
        if(is_string($recursive)) {
            $recursive=ClientRepo::getRelations($recursive);
        }
