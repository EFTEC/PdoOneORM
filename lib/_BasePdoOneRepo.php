...
{
    // it is used to check compatibility. The generated code must use the same binary version.
    public const BINARYVERSION = 14;
     ...
     * @return PdoOneQuery
     */
    public static function innerjoin(string $sql, string $condition = ''): PdoOneQuery
    {
